...
(function ZentralWorkspace() {
    ...
    injectStyles() {
      ...
      const css = `
        ...
        :root[zentral-apps-autohide="true"][zentral-apps-placement="vertical-bar"] #zentral-apps-vertical-bar .zen-app-add-btn {
          background-color: var(--zen-colors-base, #1c1c1f) !important;
          border: 1.5px dashed color-mix(in srgb, currentColor 40%, transparent) !important;
          border-radius: var(--toolbarbutton-border-radius, 8px) !important;
          opacity: 1 !important;
          transform: none !important;
          pointer-events: auto !important;
          ...
          bottom: 0 !important;
          z-index: 5 !important;
          box-shadow: 0 0 0 2px var(--zen-colors-base, #1c1c1f), 0 -2px 8px rgba(0, 0, 0, 0.3) !important;
        }
        ...
        :root[zentral-apps-autohide="true"][zentral-apps-placement="vertical-bar"] #zentral-apps-vertical-bar .zen-app-add-btn:hover {
          ...
          background-color: var(--toolbarbutton-hover-background, color-mix(in srgb, var(--zen-colors-base, #1c1c1f) 80%, currentColor 20%)) !important;
          transform: translateY(-1px) scale(1.04) !important;
          box-shadow: 0 0 0 2px var(--zen-colors-base, #1c1c1f), 0 3px 8px rgba(0, 0, 0, 0.3) !important;
        }
        ...
        :root:not([zentral-apps-autohide="true"])[zentral-apps-placement="vertical-bar"] #zentral-apps-vertical-bar .zen-app-add-btn {
          background-color: var(--zen-colors-base, var(--zen-main-browser-background, rgb(24, 24, 27))) !important;
          ...
          bottom: 0 !important;
          z-index: 5 !important;
          box-shadow: 0 0 0 2px var(--zen-colors-base, var(--zen-main-browser-background, rgb(24, 24, 27))), 0 -2px 8px rgba(0, 0, 0, 0.2) !important;
        }

        :root:not([zentral-apps-autohide="true"])[zentral-apps-placement="vertical-bar"] #zentral-apps-vertical-bar .zen-app-add-btn:hover {
          opacity: 1 !important;
          border-style: solid !important;
          background-color: var(--toolbarbutton-hover-background, color-mix(in srgb, var(--zen-colors-base, var(--zen-main-browser-background, rgb(24, 24, 27))) 80%, currentColor 20%)) !important;
          box-shadow: 0 0 0 2px var(--zen-colors-base, var(--zen-main-browser-background, rgb(24, 24, 27))), 0 2px 6px rgba(0, 0, 0, 0.2) !important;
        }
    ...
    createContainers() {
      ...
      if (!this.#dom.verticalBar) {
        ...
        vb.addEventListener("wheel", (e) => {
          if (this.isPlacementVerticalBar() && this.#dom.grid) {
            this.#dom.grid.scrollTop += e.deltaY;
          }
        }, { passive: true });
  ...
  class ZentralTabGroups {
    ...
    initTabDragSelectionGuard() {
      ...
      const onMouseDown = (e) => {
        if (e.button !== 0) return;
        // If Shift, Ctrl, Command, or Alt is held, allow native Firefox multi-tab selection
