  ...
  class ZentralApps {
    ...
    injectStyles() {
      ...
      const css = `
        ...
        #zentral-apps-vertical-bar .zen-app-tile img,
        #zentral-apps-vertical-bar .zen-app-tile svg {
        ...
        #zentral-apps-vertical-bar .zen-app-tile:hover img,
        #zentral-apps-vertical-bar .zen-app-tile:hover svg {
          filter: drop-shadow(0 2px 4px rgba(0, 0, 0, 0.5)) !important;
        }

        #zentral-apps-vertical-bar .zen-app-tile:active {
        ...
        #zentral-apps-vertical-bar .zen-app-add-btn {
          background-color: color-mix(in srgb, var(--zen-colors-base, #131313) 15%, transparent) !important;
        ...
        #zentral-apps-vertical-bar .zen-app-badge {
